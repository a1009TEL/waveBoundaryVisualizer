...
const shader_plane = new Shader("./shaders/vertex_wave.glsl", "./shaders/fragment_wave.glsl");
const shader_ui = new Shader("./shaders/vertex_ui.glsl", "./shaders/fragment_ui.glsl");
if (gl != null) {
    const positions = [];
    const normals = [];
    const uvs = [];
