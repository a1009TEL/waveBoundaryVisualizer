...
export function float2(x, y) {
    return { x, y };
}
export function float3(x, y, z) {
    return { x, y, z };
}
export function float4(x, y, z, w) {
    return { x, y, z, w };
}
//Math
// Add two 2D vectors
...
// Add two 4D vectors
export function add4(v1, v2) {
    return float4(v1.x + v2.x, v1.y + v2.y, v1.z + v2.z, v1.w + v2.w);
}
// Subtract two 2D vectors
export function subtract2(v1, v2) {
    return float2(v1.x - v2.x, v1.y - v2.y);
}
// Subtract two 3D vectors
export function subtract3(v1, v2) {
    return float3(v1.x - v2.x, v1.y - v2.y, v1.z - v2.z);
}
// Subtract two 4D vectors
export function subtract4(v1, v2) {
    return float4(v1.x - v2.x, v1.y - v2.y, v1.z - v2.z, v1.w - v2.w);
}
// Multiply two 2D vectors element-wise
export function multiply2(v1, v2) {
    return float2(v1.x * v2.x, v1.y * v2.y);
}
// Multiply two 3D vectors element-wise
export function multiply3(v1, v2) {
    return float3(v1.x * v2.x, v1.y * v2.y, v1.z * v2.z);
}
// Multiply two 4D vectors element-wise
export function multiply4(v1, v2) {
    return float4(v1.x * v2.x, v1.y * v2.y, v1.z * v2.z, v1.w * v2.w);
}
...
export function divide2(v1, v2) {
    return float2(v1.x / v2.x, v1.y / v2.y);
}
// Divide two 3D vectors element-wise
export function divide3(v1, v2) {
    return float3(v1.x / v2.x, v1.y / v2.y, v1.z / v2.z);
}
// Divide two 4D vectors element-wise
export function divide4(v1, v2) {
    return float4(v1.x / v2.x, v1.y / v2.y, v1.z / v2.z, v1.w / v2.w);
}
// -----------------------------
...
export function dot4(v1, v2) {
    return v1.x * v2.x + v1.y * v2.y + v1.z * v2.z + v1.w * v2.w;
}
// Cross product of two 3D vectors
export function cross3(v1, v2) {
    return float3(v1.y * v2.z - v1.z * v2.y, // X
...
export function normalize2(v) {
    ...
    if (length === 0)
        return float2(0, 0); // Prevent division by zero
...
export function normalize3(v) {
    ...
    if (length === 0)
        return float3(0, 0, 0); // Prevent division by zero
...
export function normalize4(v) {
    ...
    if (length === 0)
        return float4(0, 0, 0, 0); // Prevent division by zero
