...
export function lookAt(eye: Types.Float3, center: Types.Float3, up: Types.Float3): Float32Array {
...
export function lookAtRH(eye: Types.Float3, center: Types.Float3, up: Types.Float3): Float32Array {
    const f: Types.Float3 = (Types.normalize3(Types.subtract3(center, eye)));
    const s: Types.Float3 = Types.normalize3(Types.cross3(f, up));
    const u: Types.Float3 = Types.cross3(s, f);
...
export function ortho(width_aspect: number, height_aspect: number, near_clip: number, far_clip: number): Float32Array {
